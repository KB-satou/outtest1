...
export class YoYoState {
    ...
    constructor(r, theta, alpha, dr, dtheta, dalpha) {
        const ret = wasm.yoyoparams_new(r, theta, alpha, dr, dtheta, dalpha);
     ...
     */
    toObject() {
        const ret = wasm.yoyostate_toObject(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {YoYoState}
    ...
    one_step(p, dt) {
        ...
        const ret = wasm.yoyostate_one_step(this.__wbg_ptr, p.__wbg_ptr, dt);
        return YoYoState.__wrap(ret);
    }
    /**
     * @param {YoyoParams} p
    ...
    steps(p, dt, n) {
        _assertClass(p, YoyoParams);
        const ret = wasm.yoyostate_steps(this.__wbg_ptr, p.__wbg_ptr, dt, n);
        return YoYoState.__wrap(ret);
    }
}
...
export class YoyoParams {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(YoyoParams.prototype);
        obj.__wbg_ptr = ptr;
        YoyoParamsFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
     ...
     * @param {number} g
     */
    constructor(m, I, D, d, l, g) {
        const ret = wasm.yoyoparams_new(m, I, D, d, l, g);
        this.__wbg_ptr = ret >>> 0;
        YoyoParamsFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {number} m
     ...
     * @returns {YoyoParams}
     */
    static new_gmms(m, I, D, d, l) {
        const ret = wasm.yoyoparams_new_gmms(m, I, D, d, l);
        return YoyoParams.__wrap(ret);
    }
    /**
     * @returns {any}
     */
    toObject() {
        const ret = wasm.yoyoparams_toObject(this.__wbg_ptr);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasmyoyo1_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
